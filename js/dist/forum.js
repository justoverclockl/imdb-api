...
flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default.a.initializers.add('justoverclock/imdb-api', function () {
  ...
  function showMovie(movie) {
    var movieHtml = {
      ...
      plot: "<p class=\"movieDescription\" id=\"plot\">" + movie.Plot + "\n                     <span>\n                       <a id=\"imdbLink\" rel=\"nofollow\" title=" + movie.Title + " href=\"http://www.imdb.com/title/" + movie.imdbID + "/\" target=\"_blank\">\n                        <i class=\"fas fa-link linktoimdb\"></i>" + flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default.a.translator.trans('justoverclock-imdb-api.forum.fullinfoAt') + "\n                       </a>\n                     </span>\n                   </p>",
      imdbRating: "<div class=\"ratedOnImdb\" id=\"imdb\">" + flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default.a.translator.trans('justoverclock-imdb-api.forum.rateonimdb') + ":\n                            <i class=\"fas fa-star-half-alt movierated\"></i>" + movie.imdbRating + "</div>"
    };
